Delegate object is returned by some [[Trading Platform]] methods and is is required to use an [[Account Manager]]. Using this object you can get updated and update of an event.
