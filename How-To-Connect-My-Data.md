...
A sample implementation of **UDF-compatible** (case #2 described above) server-side wrapper is available [on github](https://github.com/tradingview/yahoo_datafeed). It uses Yahoo! data.
