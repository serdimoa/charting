...
**Before 1.4 version.** You can call them using widget object returned to you by widget's constructor.

**Since 1.5 version.** You can call them using chart object returned to you by widget's methods `chart(index)` or `activeChart()`.
